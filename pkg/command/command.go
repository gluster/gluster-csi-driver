...
// InitCommand parses flags and sets up cobra Command
func InitCommand(config *Config, newDriver Driver) *cobra.Command {
	// #nosec
...
// Run driver executable function
func Run(config *Config, cmd *cobra.Command) {
